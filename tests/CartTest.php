...
namespace YardEight\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use YardEight\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use YardEight\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use YardEight\Shoppingcart\ShoppingcartServiceProvider;
use YardEight\Tests\Shoppingcart\Fixtures\ProductModel;
use YardEight\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \YardEight\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \YardEight\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \YardEight\Shoppingcart\Exceptions\CartAlreadyStoredException
